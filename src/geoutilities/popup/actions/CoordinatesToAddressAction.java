...
public class CoordinatesToAddressAction implements IObjectActionDelegate {

	private Shell shell;

	public CoordinatesToAddressAction() {
		super();
	}
	...
	public void run(IAction action) {
		...
		if(!selectedText.isEmpty()){
			MessageDialog.openInformation(shell,
					"Address", 
					GeocodeService.getAddressFromCoordinates(selectedText));
		}
